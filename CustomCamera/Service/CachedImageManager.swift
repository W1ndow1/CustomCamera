...
actor CachedImageManager {
    ...
    func stopCaching(for assets: [PhotoAsset], targetSize: CGSize) {
        ...
        imageManager.stopCachingImages(for: phAsset, targetSize: targetSize, contentMode: imageContentMode, options: requestOptions)
    }
...
fileprivate let logger = Logger(subsystem: "G2.CustomCamera", category: "CachedImageManager")
